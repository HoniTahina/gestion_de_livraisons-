...
\restrict jKmYOd3psNzHW3Gufzu1pkEzvK7Qa1gPqUBI4uVeZdbE2enXtV14s9jVpTDb71c
...
--
-- Name: Products Products_vendorId_fkey2; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Products"
    ADD CONSTRAINT "Products_vendorId_fkey2" FOREIGN KEY ("vendorId") REFERENCES public."Users"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
\unrestrict jKmYOd3psNzHW3Gufzu1pkEzvK7Qa1gPqUBI4uVeZdbE2enXtV14s9jVpTDb71c
