...
\restrict u6vBFcbSvuC9kPX2YvqhGblFQ1eobgLXQ66pmoky1MQmqR3uZrgm5vzWdBkIOt8
...
--
-- Name: Deliveries Deliveries_deliveryPersonId_fkey1; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Deliveries"
    ADD CONSTRAINT "Deliveries_deliveryPersonId_fkey1" FOREIGN KEY ("deliveryPersonId") REFERENCES public."Users"(id) ON UPDATE CASCADE;
...
--
-- Name: OrderItems OrderItems_OrderId_fkey1; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."OrderItems"
    ADD CONSTRAINT "OrderItems_OrderId_fkey1" FOREIGN KEY ("OrderId") REFERENCES public."Orders"(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
--
-- Name: Orders Orders_UserId_fkey2; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: Orders Orders_vendorId_fkey2; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Orders"
    ADD CONSTRAINT "Orders_vendorId_fkey2" FOREIGN KEY ("vendorId") REFERENCES public."Users"(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
\unrestrict u6vBFcbSvuC9kPX2YvqhGblFQ1eobgLXQ66pmoky1MQmqR3uZrgm5vzWdBkIOt8
