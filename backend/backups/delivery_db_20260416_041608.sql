...
\restrict CgvnBC9AKJPqPfCgSDcdccaAelb4gZNGrgBAXKQ18JaFLy38oJT8oKOHGyDaznO
...
--
-- Name: SubOrders SubOrders_vendorId_fkey1; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."SubOrders"
    ADD CONSTRAINT "SubOrders_vendorId_fkey1" FOREIGN KEY ("vendorId") REFERENCES public."Users"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
\unrestrict CgvnBC9AKJPqPfCgSDcdccaAelb4gZNGrgBAXKQ18JaFLy38oJT8oKOHGyDaznO
