...
\restrict 7XIBx8umd7VziJDYL2zT9LFe8Gkx2Mf3Ee5fGGuJcICrk637cmeBlONNq37skAI
...
--
-- Name: InvitationCodes InvitationCodes_usedBy_fkey1; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."InvitationCodes"
    ADD CONSTRAINT "InvitationCodes_usedBy_fkey1" FOREIGN KEY ("usedBy") REFERENCES public."Users"(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
\unrestrict 7XIBx8umd7VziJDYL2zT9LFe8Gkx2Mf3Ee5fGGuJcICrk637cmeBlONNq37skAI
