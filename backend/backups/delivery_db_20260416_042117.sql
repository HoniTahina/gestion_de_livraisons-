...
\restrict VrcHdOWKzFPxbhYh8TdhoqrtEZ1gmI3XbFc6rxsOIhkDCz0BmHO6a7zwgJmne7x
...
COPY public."Orders" (id, status, total, commission, "vendorId", "createdAt", "updatedAt", "UserId", "supplierId") FROM stdin;
1	PAID	12.5	0.63	2	2026-04-16 00:30:15.89+02	2026-04-16 03:34:13.277+02	6	\N
2	PAID	299.2	14.96	3	2026-04-16 00:30:15.932+02	2026-04-16 03:34:15.391+02	6	\N
8	PAID	69.8	3.49	3	2026-04-16 00:43:15.453+02	2026-04-16 03:34:20.601+02	6	\N
7	PAID	32.4	1.62	2	2026-04-16 00:43:15.406+02	2026-04-16 03:36:02.894+02	6	\N
6	PAID	139.6	6.98	3	2026-04-16 00:38:47.059+02	2026-04-16 03:36:05.184+02	6	\N
5	PAID	32.4	1.62	2	2026-04-16 00:38:46.939+02	2026-04-16 03:36:12.528+02	6	\N
4	PAID	299.2	14.96	3	2026-04-16 00:30:25.102+02	2026-04-16 03:36:14.758+02	6	\N
3	PAID	12.5	0.63	2	2026-04-16 00:30:25.064+02	2026-04-16 03:36:16.942+02	6	\N
\.
...
--
-- Name: InvitationCodes InvitationCodes_code_key130; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."InvitationCodes"
    ADD CONSTRAINT "InvitationCodes_code_key130" UNIQUE (code);


--
-- Name: InvitationCodes InvitationCodes_code_key131; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."InvitationCodes"
    ADD CONSTRAINT "InvitationCodes_code_key131" UNIQUE (code);


--
-- Name: InvitationCodes InvitationCodes_code_key132; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."InvitationCodes"
    ADD CONSTRAINT "InvitationCodes_code_key132" UNIQUE (code);


--
-- Name: InvitationCodes InvitationCodes_code_key133; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."InvitationCodes"
    ADD CONSTRAINT "InvitationCodes_code_key133" UNIQUE (code);


--
-- Name: InvitationCodes InvitationCodes_code_key134; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."InvitationCodes"
    ADD CONSTRAINT "InvitationCodes_code_key134" UNIQUE (code);


--
-- Name: InvitationCodes InvitationCodes_code_key135; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."InvitationCodes"
    ADD CONSTRAINT "InvitationCodes_code_key135" UNIQUE (code);


--
-- Name: InvitationCodes InvitationCodes_code_key136; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."InvitationCodes"
    ADD CONSTRAINT "InvitationCodes_code_key136" UNIQUE (code);


--
-- Name: InvitationCodes InvitationCodes_code_key137; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."InvitationCodes"
    ADD CONSTRAINT "InvitationCodes_code_key137" UNIQUE (code);


--
-- Name: InvitationCodes InvitationCodes_code_key138; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."InvitationCodes"
    ADD CONSTRAINT "InvitationCodes_code_key138" UNIQUE (code);


--
-- Name: InvitationCodes InvitationCodes_code_key139; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."InvitationCodes"
    ADD CONSTRAINT "InvitationCodes_code_key139" UNIQUE (code);
...
--
-- Name: InvitationCodes InvitationCodes_code_key140; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."InvitationCodes"
    ADD CONSTRAINT "InvitationCodes_code_key140" UNIQUE (code);


--
-- Name: InvitationCodes InvitationCodes_code_key141; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."InvitationCodes"
    ADD CONSTRAINT "InvitationCodes_code_key141" UNIQUE (code);


--
-- Name: InvitationCodes InvitationCodes_code_key142; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."InvitationCodes"
    ADD CONSTRAINT "InvitationCodes_code_key142" UNIQUE (code);


--
-- Name: InvitationCodes InvitationCodes_code_key143; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."InvitationCodes"
    ADD CONSTRAINT "InvitationCodes_code_key143" UNIQUE (code);


--
-- Name: InvitationCodes InvitationCodes_code_key144; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."InvitationCodes"
    ADD CONSTRAINT "InvitationCodes_code_key144" UNIQUE (code);


--
-- Name: InvitationCodes InvitationCodes_code_key145; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."InvitationCodes"
    ADD CONSTRAINT "InvitationCodes_code_key145" UNIQUE (code);


--
-- Name: InvitationCodes InvitationCodes_code_key146; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."InvitationCodes"
    ADD CONSTRAINT "InvitationCodes_code_key146" UNIQUE (code);


--
-- Name: InvitationCodes InvitationCodes_code_key147; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."InvitationCodes"
    ADD CONSTRAINT "InvitationCodes_code_key147" UNIQUE (code);
...
--
-- Name: Orders Orders_UserId_fkey1; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: Orders Orders_vendorId_fkey1; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Orders"
    ADD CONSTRAINT "Orders_vendorId_fkey1" FOREIGN KEY ("vendorId") REFERENCES public."Users"(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
\unrestrict VrcHdOWKzFPxbhYh8TdhoqrtEZ1gmI3XbFc6rxsOIhkDCz0BmHO6a7zwgJmne7x
