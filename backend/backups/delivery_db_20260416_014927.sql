...
\restrict W8ppI2iSaTMB8ZwJhrZl8hosRge1kiyIGrueC1cygwvfpQUcXevcy4MxKYAObQy
...
--
-- Name: OrderItems OrderItems_SubOrderId_fkey1; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."OrderItems"
    ADD CONSTRAINT "OrderItems_SubOrderId_fkey1" FOREIGN KEY ("SubOrderId") REFERENCES public."SubOrders"(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
--
-- Name: Products Products_vendorId_fkey1; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Products"
    ADD CONSTRAINT "Products_vendorId_fkey1" FOREIGN KEY ("vendorId") REFERENCES public."Users"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: SubOrders SubOrders_OrderId_fkey1; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."SubOrders"
    ADD CONSTRAINT "SubOrders_OrderId_fkey1" FOREIGN KEY ("OrderId") REFERENCES public."Orders"(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
\unrestrict W8ppI2iSaTMB8ZwJhrZl8hosRge1kiyIGrueC1cygwvfpQUcXevcy4MxKYAObQy
