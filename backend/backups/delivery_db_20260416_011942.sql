...
\restrict sh56s3wIRyVaxU86oloa7maWuqBOYoe5TF5aNCTqvbX2B7AemBBjDKI7Z30SRgd
...
COPY public."Deliveries" (id, status, "deliveryPersonId", "createdAt", "updatedAt", "OrderId", "trackingToken", "SubOrderId") FROM stdin;
\.
...
\unrestrict sh56s3wIRyVaxU86oloa7maWuqBOYoe5TF5aNCTqvbX2B7AemBBjDKI7Z30SRgd
